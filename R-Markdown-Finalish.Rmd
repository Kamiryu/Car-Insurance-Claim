...
# The fitted tree has only one leaf and thus I get an error with the following code:

# library(rattle)        # Enhanced tree: fancyRpartPlot
# fancyRpartPlot(pruned.tree, # Graph model
#                uniform=TRUE,
...
```{r}
pred_tree_tr_pruned <- predict(pruned.tree, # Pruned tree
                         cars_train[,c(-6)], # Train set
                         type ="class")
