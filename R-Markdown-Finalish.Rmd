...
ensemble <- data.table(actual_outcome,tree.outcome2,knn_outcome2,logi_outcome2)
...
# # Majority vote
# ensemble[, maj_vote := as.numeric(logi_pred) + ifelse(as.numeric(knn_pred) == 1, 0, 1) + as.numeric(tree_pred)]
# 
# ensemble[, maj_vote := ifelse(maj_vote >= 2, 1, 0)]
# 
