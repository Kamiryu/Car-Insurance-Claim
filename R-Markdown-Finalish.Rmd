...
Plotting the classification tree with the trained data results in only 1 leaf. Such an output is surprising. The problem could lies in the fact that the explaind variable is inbalanced in our dataset. Let's try again with a downsample dataset.
