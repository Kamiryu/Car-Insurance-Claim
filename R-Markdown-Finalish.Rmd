...
```
Since we are looking fo k which give us max optimum value of Specificity we chose k = 48  
 
```{r}
knn.pred.valid <- knn(train_new[, -16], valid_dummy[, -16], cl = train_new[, 16], k = 48 ,prob = T)     #prediction on validation data using best k=6
