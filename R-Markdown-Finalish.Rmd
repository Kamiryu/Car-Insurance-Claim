...
cars %>% select(4,7:12,14:19,22,24,30:41) %>% gather() %>%
 ...
 theme_minimal()
```
## correlation analysis in order to drop the high corrletted one 
...
## droped some variables based on random forest analysis and correlation 
...
## final data set after dropping some variabl by using logistic regression 
```{r}
...
### for loop for finding the optimum k for each measurement 
