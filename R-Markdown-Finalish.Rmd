...
Accuracy <- cbind(Accuracy,NN=round(conf_matrix_1H4N_valid$overall[1],3))     #predict accuracy by using neural network
...
Specificity_P <- cbind(Specificity_P,NN=round(conf_matrix_1H4N_valid$byClass[2],3))    #predict specificity neural network
...
Sensitivity <- cbind(Sensitivity,NN=round(conf_matrix_1H4N_valid$byClass[1],3))    #predict Sensitivity  neural network
